...
def simple_conv_net_diffuser_experiment():
    ...
    train_model(model, X_train_batches, y_train_batches, generator, betas, num_diffusion_steps=T, num_epochs=1, learning_rate=0.001, model_save_filename=model_save_filename)
